...
const Footer: React.FC = () => {
  return (
    <footer className="pt-32 pb-12 px-6 border-t border-white/5 bg-gradient-to-b from-transparent to-blue-950/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="md:col-span-1">
            ...
            <p className="text-white/40 text-sm mb-8 leading-relaxed">
              Essential technology partners for the bold. Proudly engineered in Nashik, serving the globe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/40">
              ...
              <li className="hover:text-blue-400 cursor-pointer transition-colors">CRM Solutions</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">AI Automation</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Strategic Consulting</li>
            </ul>
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest mb-6">Insights</h4>
            <p className="text-sm text-white/40 mb-6 leading-relaxed">Executive-level insights on technology and growth, delivered weekly.</p>
            <form className="relative">
              <input
                type="email"
                placeholder="work@company.com"
                className="w-full glass border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-500 transition-colors"
              />
              <ShimmerButton className="absolute right-2 top-1.5 bottom-1.5 px-6 py-0 text-xs z-10 h-auto shadow-lg hover:shadow-blue-500/25">
